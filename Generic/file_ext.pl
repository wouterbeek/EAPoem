...
@author Wouter Beek
@version 2011/08-2012/05, 2012/09
*/
...
file_name(File, Directory, Name, Type):-
  file_directory_name(File, Directory),
  file_base_name(File, LocalFile),
  file_name_type(Name, Type, LocalFile).

%% file_name_type(?Name:atom, ?Type:atom, ?File:atom) is nondet.
...
file_name_type(Name, Type, File):-
  (nonvar(Name), nonvar(Type),! ; nonvar(File),!),
  file_name_type0(Name, Type, File),!.
file_name_type(Name, Type, File):-
  file_name_type0(Name, Type, File).
